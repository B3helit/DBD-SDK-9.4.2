...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0B886740;
	constexpr int32 AppendString      = 0x01519EC0;
	constexpr int32 GNames            = 0x0B7B30C0;
	constexpr int32 GWorld            = 0x0BA3C8F0;
	constexpr int32 ProcessEvent      = 0x0172E380;
